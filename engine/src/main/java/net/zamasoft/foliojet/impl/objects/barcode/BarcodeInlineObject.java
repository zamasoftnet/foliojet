...
import net.zamasoft.foliojet.impl.objects.barcode.isbn.ISBN;
import net.zamasoft.foliojet.impl.objects.barcode.jp4scc.JP4SCC;
import net.zamasoft.foliojet.impl.objects.barcode.qrcode.QRCode;
