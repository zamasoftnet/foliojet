...
/**
 * max-inline-size 特性(論理プロパティ)です。writing-modeにより
 * max-width か max-height のいずれかに対応します。
 */
public final class MaxInlineSize extends AbstractPrimitivePropertyInfo {
	public static final PrimitivePropertyInfo INFO = new MaxInlineSize();

	public static Value get(CSSStyle style) {
		PrimitivePropertyInfo physicalInfo = BlockFlow.get(style).isVertical() ? MaxHeight.INFO : MaxWidth.INFO;
