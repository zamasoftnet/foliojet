...
public class WidthHeightTest extends AbstractTestCase {
	public WidthHeightTest(String name) {
		super(name);
	}

	protected void transcode() throws Exception {
		File file = new File("files/unittest/0430-direction-mode/width-height.html");
