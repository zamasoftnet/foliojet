...
public class FixedColwidthPercentageTest extends AbstractTestCase {
	protected void transcode() throws Exception {
		File file = new File(
				"files/unittest/0070-table-layout/fixed-colwidth-percentage.html");
		CTISessionHelper.transcodeFile(this.session, file, "text/html", null);
	}

	public FixedColwidthPercentageTest(String name) {
		super(name);
	}
	...
	public boolean check_ac(IBox box, int pageNumber, double x, double y) {
		if (box.getType() == IBox.TYPE_TABLE_CELL) {
			System.out.println(box.getWidth());
			assertEquals(310, box.getWidth(), 1);
			return true;
		}
		return false;
	}
	...
	public boolean check_ad(IBox box, int pageNumber, double x, double y) {
		if (box.getType() == IBox.TYPE_TABLE_CELL) {
			System.out.println(box.getWidth());
			assertEquals(180, box.getWidth(), 0);
			return true;
		}
		return false;
	}
	...
	public boolean check_ae(IBox box, int pageNumber, double x, double y) {
		if (box.getType() == IBox.TYPE_TABLE_CELL) {
			System.out.println(box.getWidth());
			assertEquals(80, box.getWidth(), 1);
			return true;
		}
		return false;
	}
	...
	public boolean check_ag(IBox box, int pageNumber, double x, double y) {
		if (box.getType() == IBox.TYPE_TABLE_CELL) {
			System.out.println(box.getWidth());
			assertEquals(201, box.getWidth(), 1);
			return true;
		}
		return false;
	}
	...
	public boolean check_bd(IBox box, int pageNumber, double x, double y) {
		if (box.getType() == IBox.TYPE_TABLE_CELL) {
			System.out.println(box.getWidth());
			assertEquals(180, box.getWidth(), 1);
			return true;
		}
		return false;
	}
