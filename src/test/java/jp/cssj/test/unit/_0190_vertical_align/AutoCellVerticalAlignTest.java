...
public class AutoCellVerticalAlignTest extends AbstractTestCase {
	protected void transcode() throws Exception {
		File file = new File(
				"files/unittest/0190-vertical-align/auto-cell-vertical-align.html");
		CTISessionHelper.transcodeFile(this.session, file, "text/html", null);
	}

	public AutoCellVerticalAlignTest(String name) {
		super(name);
	}
