...
public class OutputIntentTest extends AbstractTestCase {
	...
	protected void transcode() throws Exception {
		...
		this.session.property("output.pdf.output-intent.identifier", "JC200103");
		this.session.property("output.pdf.output-intent.condition", "Japan Color 2001 Coated");
		this.session.property("output.pdf.output-intent.icc-profile",
				new File("files/unittest/9500-PROFILE/fake-cmyk.icc").toURI().toString());
		...
		assertTrue("出力条件識別名が出ること", pdf.contains("JC200103"));
		assertTrue("レジストリ名が出ること", pdf.contains("www.color.org"));
		assertTrue("人間可読名が出ること", pdf.contains("Japan Color 2001 Coated"));
